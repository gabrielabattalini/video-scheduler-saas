...
export const translations: Record<Language, Translations> = {
  ...
  ru: {
    ...
    connections: {
      ...
      loading: "Загружаем подключения...",
      connected: "Подключено",
      connectedAs: "Подключено как",
      disconnect: "Отключить",
      connecting: "Подключаем...",
      colorLabel: "Цвет",
      addAccount: "Добавить еще аккаунт",
      ...
      platformDescriptions: {
        ...
        kawai: "Подключитесь к платформе Kawai",
      },
    },
    newPost: {
      title: "Новый пост",
    ...
    workspaces: {
      ...
      confirmSwitchTitle: "Выбрать workspace",
      choose: "Выберите workspace",
      active: "Активный",
      noWorkspaces: "Рабочие пространства не найдены",
      goManage: "Управлять workspaces",
    ...
    landing: {
      ...
      heroSubtitle:
        "Полная платформа для планирования, редактирования и публикации видео на YouTube, TikTok, Instagram и других.",
  ...
  zh: {
    ...
    landing: {
      ...
      heroHighlight: "到多个平台",
      heroSubtitle:
        "在 YouTube、TikTok、Instagram 等平台上安排、编辑和发布视频的一体化平台。",
      ctaPrimary: "免费开始",
      ctaSecondary: "查看功能",
      noCard: "立即开始",
      footerTagline: "一站式视频安排和发布平台。",
      footerTemplates: "模板",
    },
  },
};
