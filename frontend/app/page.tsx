...
const copyByLang: Record<Language, LandingCopy> = {
  ...
  ru: {
    ...
    featuresTitle: 'Всё, что нужно для управления вашими видео',
    featuresSubtitle: 'Мощные инструменты, чтобы превращать идеи в профессиональные ролики',
    features: [
      {
        icon: Video,
        title: 'Умное планирование',
        description: 'Планируйте посты на лучшие часы сразу на нескольких платформах.',
        color: 'text-blue-600 bg-blue-100',
      },
      {
        icon: Sparkles,
        title: 'Мультиплатформенность',
        description: 'Публикуйте на YouTube, TikTok, Instagram и других сетях одним кликом.',
        color: 'text-purple-600 bg-purple-100',
      },
      {
        icon: Zap,
        title: 'Автоматическая публикация',
        description: 'Автоматизируйте публикацию ваших видео в подключённых соцсетях.',
        color: 'text-yellow-600 bg-yellow-100',
      },
      {
        icon: Shield,
        title: 'Безопасно и надёжно',
        description: 'Ваши подключения защищены, а видео хранятся в облаке.',
        color: 'text-green-600 bg-green-100',
      },
      {
        icon: Video,
      ...
      },
      {
        ...
        description: 'Следите за эффективностью постов на всех платформах.',
        color: 'text-indigo-600 bg-indigo-100',
      },
    ],
    howTitle: 'Как это работает',
    howSubtitle: '3 шага — и вы планируете и публикуете видео',
    steps: [
      {
        step: '01',
        title: 'Подключите сети',
        description: 'Подключите аккаунты YouTube, TikTok, Instagram и других платформ.',
      },
      {
        step: '02',
        title: 'Создайте и запланируйте',
        description: 'Создайте пост, загрузите видео и выберите время публикации.',
      },
      {
        step: '03',
    ...
    featuresSubtitle: '强大的工具，帮助你把想法变成专业视频',
    features: [
      {
        icon: Video,
        title: '智能排期',
        description: '在多个平台同时为你的帖子安排最佳时间。',
        color: 'text-blue-600 bg-blue-100',
      },
      {
        icon: Sparkles,
        title: '多平台',
        description: '一键发布到 YouTube、TikTok、Instagram 等社交平台。',
        color: 'text-purple-600 bg-purple-100',
      },
      {
        icon: Zap,
        title: '自动发布',
        description: '自动将视频发布到已连接的社交网络。',
        color: 'text-yellow-600 bg-yellow-100',
      },
      {
        icon: Shield,
        title: '安全可靠',
        description: '连接安全，视频云端存储更安心。',
        color: 'text-green-600 bg-green-100',
      },
      {
        icon: Video,
        title: '视频编辑',
        description: '直接在平台内编辑和创建专业视频。',
        color: 'text-red-600 bg-red-100',
      },
      {
        icon: Sparkles,
        title: '分析与指标',
        description: '跟踪各平台帖子的表现。',
        color: 'text-indigo-600 bg-indigo-100',
      },
    ],
    howTitle: '如何运作',
    howSubtitle: '3 个步骤即可安排并发布视频',
    steps: [
      {
        step: '01',
        title: '连接社交账号',
      ...
      },
      {
        step: '03',
        title: '自动发布',
        description: '平台会在指定时间自动发布视频。',
      },
    ],
    ctaTitle: '准备好开始了吗？',
    ctaSubtitle: '加入已经使用 Autoedito 的数千创作者',
    ctaPrimary: '免费创建账号',
    footer: {
      product: '产品',
      company: '公司',
