...
const plansByLang: Record<Language, Plan[]> = {
  pt: [
    ...
    },
    {
      ...
      features: ['Até 60 posts por mês', 'Até 6 plataformas conectadas', 'Workspaces ilimitados', 'Agendamento', 'Suporte dedicado'],
      cta: 'Assinar agora',
      popular: false,
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      features: ['Up to 60 posts per month', 'Up to 6 connected platforms', 'Unlimited workspaces', 'Scheduling', 'Dedicated support'],
      cta: 'Subscribe now',
      popular: false,
    },
    {
  ...
  ru: [
    ...
    },
    {
      ...
      features: ['До 60 постов в месяц', 'До 6 подключенных платформ', 'Безлимитные рабочие пространства', 'Планирование', 'Выделенная поддержка'],
      cta: 'Оформить подписку',
      popular: false,
    },
    {
  ...
  zh: [
    ...
    },
    {
      ...
      period: '/月',
      description: '适合团队和机构',
      features: ['每月最多 60 条帖子', '最多 6 个已连接的平台', '无限工作区', '排程', '专属支持'],
      cta: '立即订阅',
      popular: false,
    },
    {
