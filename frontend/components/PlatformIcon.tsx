...
export type PlatformKey = 'youtube' | 'tiktok' | 'instagram' | 'facebook' | 'twitter' | 'kawai';
...
export const platformMeta: Record<PlatformKey, { label: string; color: string }> = {
  ...
  kawai: { label: 'Kawai', color: '#FF69B4' },
};
...
export function PlatformIcon({ platform, size = 18 }: Props): ReactElement {
  switch (platform) {
    case 'youtube':
      return (
    ...
    case 'instagram':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="#E4405F" aria-hidden="true">
    ...
    case 'kawai':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="#FF69B4" aria-hidden="true">
